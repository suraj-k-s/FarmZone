...
if(isset($_POST["btnsave"]))
{
	...
	$insQry="insert into tbl_farmer(farmer_name,farmer_email,farmer_address,farmer_contact,place_id,farmer_password,farmer_photo,farmer_proof)values('".$_POST["txtname2"]."','".$_POST["txtemail"]."','".$_POST["txtaddress"]."','".$_POST["txtcontact"]."','".$_POST["selplace"]."','".$_POST["txtpassword"]."','".$photo."','".$proof."')";
  ...
  <table align="center" width="200" border="1">
   <tr>
    ...
    <tr>
      ...
      <input type="text" name="txtpassword" id="txtpassword" required="" /></td>
    </tr>
    <tr>
      <td>Address</td>
