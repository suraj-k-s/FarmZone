                                            ...
                                            <div class="quick_activity_wrap">
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        ...
                                                        <?php
														$sel = "select count(farmer_id) as id from tbl_farmer";
                                                ...
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        <h3><span class="counter">
                                                        <?php
														$sel = "select count(seller_id) as id from tbl_seller";
														$result = $Conn->query($sel);
														$data = $result->fetch_assoc();
														echo $data["id"];
                                                        ?>
                            ...
                            <div class="white_box card_height_100">
                                <div class="box_header border_bottom_1px  ">
                                    <div class="main-title">
                                        <h3 class="mb_25">Farmer</h3>
                                    </div>
                                </div>
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    <?php
                                        $selQry = "select * from tbl_farmer";
                                    ...
                                    <div class="single_staf">
                                        ...
                                        <p><?php echo $data1["farmer_contact"] ?></p>
                                    </div>
                                    <?php
                                        }
                                    ?>
                        ...
                        <div class="col-xl-12">
                            <div class="white_box card_height_100">
                                ...
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Files/Seller/Photo/<?php echo $data1["seller_photo"] ?>" alt="">
                                        </div>
                                        <h4><?php echo $data1["seller_name"] ?></h4>
                                        <p><?php echo $data1["seller_contact"] ?></p>
                                    </div>
                                    <?php
                                        }
                                    ?>
                        ...
                        <div class="col-xl-12">
                            <div class="white_box card_height_100">
                                ...
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Files/User/Photo/<?php echo $data1["user_photo"] ?>" alt="">
                                        </div>
