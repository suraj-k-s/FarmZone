...
$sel="select * from tbl_farmer where farmer_id=".$_SESSION["fid"];
$res=$Conn->query($sel);
$row=$res->fetch_assoc();
...
if(isset($_POST["btn_update"]))
{
	...
	$up="update tbl_farmer set farmer_name='".$na."',farmer_contact='".$co."' , farmer_email='".$em."' , farmer_address='".$add."' where farmer_id=".$_SESSION["fid"];
	if($Conn->query($up))
	{
		?>
		<script>
