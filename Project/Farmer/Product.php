...
if(isset($_POST["btnsave"]))
{
	...
	$insQry ="insert into tbl_farmerproduct(producttype_id,fproduct_name,fproduct_photo,fproduct_details,fproduct_rate,farmer_id) values('".$producttype_id."','".$name."','".$photo."','".$details."','".$price."','".$_SESSION["fid"]."')";
...
{
    $id=$_GET["id"];	
    $delQry="delete from tbl_farmerproduct where fproduct_id='".$_GET["id"]."'";
...
if(isset($_GET["pid"]))
{
	$selQry="select * from tbl_farmerproduct where fproduct_id='".$_GET["pid"]."'";
...
<h1 align="center">Product</h1>
  ...
  <?php
  $i=0;
  $selQry="select * from tbl_farmerproduct p inner join tbl_producttype s on p.producttype_id=s.producttype_id where farmer_id='".$_SESSION["fid"]."'";
