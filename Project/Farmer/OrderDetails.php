...
$selQry="select *from tbl_farmerproductbooking b inner join tbl_farmercart c on c.fpbooking_id=b.fpbooking_id inner join tbl_farmerproduct p on p.fproduct_id=c.fproduct_id where p.farmer_id='".$_SESSION["fid"]."' and b.fpbooking_status!='0' and c.fcart_status!='0'";
$res=$Conn->query($selQry);
if(isset($_GET["cid"]))

	{
		$upQry="update tbl_farmercart set fcart_status='".$_GET["sts"]."' where fcart_id='".$_GET["cid"]."' ";
		if($Conn->query($upQry))
		{
			?>
            <script>
