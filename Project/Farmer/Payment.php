...
session_start();
	...
	if(isset($_POST["btn_pay"]))
	{
				...
				$a = "update tbl_sellerproductbooking set spbooking_status='2' where spbooking_id='".$_SESSION["bid"]."'";
				if($Conn->query($a))
				{
...
<body>
	<div class="wrapper">
		...
		<form method="POST">
			...
			<div class="input-group">
				<div class="input-box">
					<input class="name" type="password" name="txtcvc" id="txtcvc" data-mask="000" placeholder="CVC" required>
					<i class="fa fa-user icon" aria-hidden="true"></i>
				</div>
				<div class="input-box">
