...
if(isset($_POST["btnsave"]))
{
	...
	$insQry ="insert into tbl_farmerstock(fstock_date,fstock_count,fproduct_id) values(curdate(),'".$quantity."','".$pid."')";
...
{
    $id=$_GET["did"];	
    $delQry="delete from tbl_farmerstock where fstock_id='".$id."'";
...
<h1 align="center">Stock</h1>
  ...
  <?php
      $i=0;
	  $selQry="select * from tbl_farmerstock where fproduct_id='".$_GET["pid"]."'";
