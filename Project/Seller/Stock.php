...
if(isset($_POST["btnsave"]))
{
	...
	$insQry ="insert into tbl_sellerstock(sstock_date,sstock_count,sproduct_id) values(curdate(),'".$quantity."','".$pid."')";
...
{
    $id=$_GET["did"];	
    $delQry="delete from tbl_sellerstock where sstock_id='".$id."'";
...
<h1 align="center">Stock</h1>
  ...
  <?php
      $i=0;
	  $selQry="select * from tbl_sellerstock where sproduct_id='".$_GET["pid"]."'";
  ...
  ?>
   <tr>
	<td><?php echo $i;?></td> 
    <td><?php echo $row["sstock_date"];?></td>
    <td><?php echo $row["sstock_count"];?></td>
	<td><a href="Stock.php?did=<?php echo $row["sstock_id"];?>&pid=<?php echo $_GET["pid"]; ?>">Delete</a></td>
