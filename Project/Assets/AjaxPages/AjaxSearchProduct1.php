...
include("../Connection/Connection.php");
    ...
    if (isset($_GET["action"])) {
        ...
        $sqlQry = "SELECT * from tbl_farmerproduct p inner join tbl_producttype pt on pt.producttype_id=p.producttype_id inner join tbl_farmer k on k.farmer_id=p.farmer_id where true ";
                                ...
                                <div class="card border-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p align="center">
                                            ...
                                            $stock = "select sum(fstock_count) as stock from tbl_farmerstock where fproduct_id = '" . $rowS["fproduct_id"] . "'";
											$result2 = $Conn->query($stock);
                            				$row2=$result2->fetch_assoc();
											
											$stocka = "select sum(fcart_quantity) as stock from tbl_farmercart where fproduct_id = '" . $rowS["fproduct_id"] . "'";
