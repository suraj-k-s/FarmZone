...
$selqry="select * from tbl_farmercart c inner join tbl_farmerproductbooking b on b.fpbooking_id=c.fpbooking_id inner join tbl_user u on u.user_id=b.user_id inner join tbl_farmerproduct p on p.fproduct_id=c.fproduct_id inner join tbl_farmer k on k.farmer_id=p.farmer_id where c.fcart_id='".$_GET["id"]."'";
