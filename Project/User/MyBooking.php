...
include("../Assets/Connection/Connection.php");
	{
		$selQry="select * from tbl_farmerproductbooking b inner join tbl_farmercart c on c.fpbooking_id = b.fpbooking_id inner join  tbl_farmerproduct p on p.fproduct_id = c.fproduct_id inner join tbl_farmer k on k.farmer_id=p.farmer_id where user_id='".$_SESSION["uid"]."' and fpbooking_status>0 and fcart_status>0"; 
